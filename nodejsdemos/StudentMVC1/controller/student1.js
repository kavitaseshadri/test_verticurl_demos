...
const studentmongodb = require('../model/studentmongodb');

// module.exports.getAllStudents = async (req, res, next) => {
//     res.setHeader('Content-Type', 'application/html');
//     let studentRecords = null;
//     await studentmongodb.getAllStudents()
//         .then((students) => {
...
//we need one more controller, that will only do the job of sending back addStudent view?

//once the addStudent form has been submitted, so this one is for post request
